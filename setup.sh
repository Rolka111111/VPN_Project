...
#
# Add Domain
wget https://raw.githubusercontent.com/owl64/VPN_Project/main/updated/adddomain.sh && chmod +x adddomain.sh && ./adddomain.sh
#
#install tools/alat
wget https://raw.githubusercontent.com/owl64/VPN_Project/main/install-tools.sh && chmod +x install-tools.sh && ./install-tools.sh
#
#Instal Xray
