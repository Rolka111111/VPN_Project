...
wget -q -O /usr/bin/proxy3.js "https://raw.githubusercontent.com/Rolka111111/VPN_Project/master/ssh/proxy3.js"
...
wget -q -O /usr/bin/ssh-wsenabler "https://raw.githubusercontent.com/Rolka111111/VPN_Project/master/ssh/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler && /usr/bin/ssh-wsenabler
